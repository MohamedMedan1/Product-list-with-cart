    ...
    return (
        <div className="confirm-box">
            ...
            <ul className="ordered-products">
                {purchasedProducts.map(({image,name,price,quantity,id}) => <li key={id}>
                    <CartProductItem>
                        <div className="startOf-productBox">
                        <div className="confirmedProdcutImg-box">
                            <img src={image} alt="product-image" />
                        </div>
                        <div className="confirmedProduct-desc">
                            <div className="confirmedProduct-name">
                                <p>{name}</p>
                            </div>
